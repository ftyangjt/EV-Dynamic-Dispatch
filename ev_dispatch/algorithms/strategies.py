...
COMPOSITE_CONFIG_PRESETS = {
    ...
    "tuned": CompositeScoreConfig(
        ...
        priority_weight=15,
        urgency_weight=30,
        urgency_floor_hours=1.25279,
        load_fit_weight=5.45203,
        pickup_distance_weight=3.17051,
        delivery_distance_weight=0.058798,
        travel_time_weight=0.519428,
        energy_weight=1.7876,
        lateness_weight=150.407,
        station_wait_weight=9.89757,
        station_distance_weight=0.44517,
        low_battery_ratio_threshold=0.053994,
        low_battery_penalty_weight=74.8608,
        reserve_energy_kwh=7.15301,
    ),
}
